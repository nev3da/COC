...
# Form implementation generated from reading ui file 'c:\Python_projects\game_scripts\COC\ui.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.execute_time = QtWidgets.QSpinBox(self.widget_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.execute_time.sizePolicy().hasHeightForWidth())
        self.execute_time.setSizePolicy(sizePolicy)
        self.execute_time.setMaximumSize(QtCore.QSize(80, 16777215))
        self.execute_time.setProperty("value", 3)
        ...
        self.number = QtWidgets.QSpinBox(self.widget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
